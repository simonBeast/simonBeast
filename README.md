...
🔹 **Hidyat Ride-Hailing Platform**
Admin, dispatcher, and support dashboards with real-time vehicle tracking, SOS alerts, and in-app notification messaging. Built with **Vue.js** and **Socket.io**.

🔹 **Chinet Transport Management System**
End-to-end fleet platform covering real-time vehicle location, movement, health, and speed tracking; finance and inventory management; timely reporting and real-time notifications; order and shipment management; fuel management; preventive and corrective maintenance tracking; and asset management. Built with **NestJS**, **MongoDB**, and **Vue.js**.

🔹 **Multilingual Inventory System**
Stock management platform with full language localization and role-based access control (RBAC). Built with **Vue.js**, **Express.js**, and **MySQL**.
...
**Frameworks & Libraries:** `React` `Vue.js` `Flutter` `TailwindCSS` `Node.js` `Express` `NestJS`
**Databases:** `PostgreSQL` `MongoDB` `MySQL`
**DevOps & Tooling:** `Docker` `GitHub Actions` `Socket.io` `REST APIs`
